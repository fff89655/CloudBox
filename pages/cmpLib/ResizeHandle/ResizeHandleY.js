var template = `
<div ref="div" class="resizehandle" style="width:100%;user-select:none;" @mousedown="onMouseDown" >
</div>
`;

Vue.component('resizehandle-y', {
    props: [],
    template: template,
    data: function () {
        return {};
    ...
    methods: {
        ...
        onMouseMove:function(e){
            ...
            this.handleEl.css("top", e.pageY + "px");
            this.handleEl.css("left", p.left + "px");
        },
        onMouseUp:function(){
            let offset = this.handleEl.offset().top - this.mouseDownPoint.top;
